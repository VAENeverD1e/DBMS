...
/**
 * ListenerSubscriptionPage Component
 * 
 * Subscription status page for listeners who have already purchased a subscription
 * Shows current subscription information and RENEW button
 */
const ListenerSubscriptionPage = () => {
  ...
  const listenerNavItems = [
    { label: "Home", path: "/listener/home" },
    { label: "Subscription", path: "/listener/subscription" },
  ...
  return (
    <div className="flex h-screen bg-[#3E3B2C] overflow-hidden">
      {/* Left Sidebar */}
      <Sidebar userRole="LISTENER" navItems={listenerNavItems} onLogout={handleLogout} />
      ...
      <div className="flex-1 flex flex-col bg-[#3E3B2C] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-hide">
          ...
          <div className="grid grid-cols-2 gap-6">
            {/* LISTENER PACKAGE - Current Subscription */}
            <motion.div
            ...
            >
              <div className="flex items-start gap-6 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[#3E3B2C] text-lg font-semibold mb-6">
            ...
            {/* ARTIST PACKAGE - Available for Upgrade */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
...
export default ListenerSubscriptionPage;
